...
- Rename `\Heptacom\HeptaConnect\Storage\ShopwareDal\EntityMapper` to `\Heptacom\HeptaConnect\Storage\ShopwareDal\Action\Mapping\MappingMap` and implement `\Heptacom\HeptaConnect\Storage\Base\Contract\Action\Mapping\MappingMapActionInterface` with `\Heptacom\HeptaConnect\Storage\ShopwareDal\Action\Mapping\Mapping` in addition
