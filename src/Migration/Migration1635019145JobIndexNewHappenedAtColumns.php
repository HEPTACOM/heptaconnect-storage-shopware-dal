...
final class Migration1635019145JobIndexNewHappenedAtColumns extends MigrationStep
{
...
SQL;
    ...
    {
        $this->addDateTimeIndex($connection, 'heptaconnect_job', 'started_at');
        $this->addDateTimeIndex($connection, 'heptaconnect_job', 'finished_at');
    }
